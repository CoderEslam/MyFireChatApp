package com.doubleclick.storagechooser.fragments;
...
import com.doubleclick.storagechooser.Content;
import com.doubleclick.storagechooser.R;
import com.doubleclick.storagechooser.StorageChooser;
import com.doubleclick.storagechooser.adapters.SecondaryChooserAdapter;
import com.doubleclick.storagechooser.filters.UniversalFileFilter;
import com.doubleclick.storagechooser.models.Config;
import com.doubleclick.storagechooser.utils.DiskUtil;
import com.doubleclick.storagechooser.utils.FileUtil;
import com.doubleclick.storagechooser.utils.ResourceUtil;
...
//        mNewFolderButton.setImageDrawable(ContextCompat.getDrawable(mContext, R.drawable.plus));
    ...
    private void initUI() {
        ...
        mNewFolderView.setBackgroundColor(scheme[StorageChooser.Theme.SEC_FOLDER_CREATION_BG_INDEX]);
        ...
        (mLayout.findViewById(R.id.secondary_container)).setBackgroundColor(scheme[StorageChooser.Theme.SEC_BG_INDEX]);
    ...
    private void updateUI() {
        ...
        if (Build.VERSION.SDK_INT >= Build.VERSION_CODES.LOLLIPOP) {
            mFolderNameEditText.setHintTextColor(scheme[StorageChooser.Theme.SEC_HINT_TINT_INDEX]);
        }
        ...
        // set colors
        mSelectButton.setTextColor(scheme[StorageChooser.Theme.SEC_SELECT_LABEL_INDEX]);
        mPathChosen.setTextColor(scheme[StorageChooser.Theme.SEC_ADDRESS_TINT_INDEX]);
        ...
        if (Build.VERSION.SDK_INT >= Build.VERSION_CODES.LOLLIPOP) {
            mNewFolderImageView.setImageTintList(ColorStateList.valueOf(scheme[StorageChooser.Theme.SEC_ADDRESS_TINT_INDEX]));
            mBackButton.setImageTintList(ColorStateList.valueOf(scheme[StorageChooser.Theme.SEC_ADDRESS_TINT_INDEX]));
        }
        mMultipleOnSelectButton.setBackgroundTintList(ColorStateList.valueOf(scheme[StorageChooser.Theme.SEC_DONE_FAB_INDEX]));
        mLayout.findViewById(R.id.custom_path_header).setBackgroundColor(scheme[StorageChooser.Theme.SEC_ADDRESS_BAR_BG]);
    ...
    private void initListView(Context context, View view, boolean shouldShowMemoryBar) {
        ...
        if (Build.VERSION.SDK_INT >= Build.VERSION_CODES.LOLLIPOP) {
            mFilesProgress.setIndeterminateTintList(ColorStateList.valueOf(scheme[StorageChooser.Theme.OVERVIEW_MEMORYBAR_INDEX]));
        }
    ...
    private void handleListMultipleAction(int i, View view) {
        ...
        if (!secondaryChooserAdapter.selectedPaths.contains(i)) {
            ...
            // reset bg to white
            view.setBackgroundColor(scheme[StorageChooser.Theme.SEC_BG_INDEX]);
