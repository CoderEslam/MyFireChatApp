...
package com.doubleclick.fastscroller
...
import com.doubleclick.fastscroller.R
import com.doubleclick.fastscroller.extension.compatPaddingStart
import com.doubleclick.fastscroller.extension.firstVisibleItemPosition
import com.doubleclick.fastscroller.extension.getCompatDrawable
import com.doubleclick.fastscroller.extension.isLayoutReversed
import com.doubleclick.fastscroller.extension.setCompatTint
import com.doubleclick.fastscroller.extension.wrap
 ...
 * [R.styleable.FastScroller_showBubbleAlways]
...
class FastScroller : LinearLayout {
    ...
    @ColorInt private var bubbleColor = 0
    @ColorInt private var handleColor = 0
    ...
    fun setLayoutParams(viewGroup: ViewGroup) {
        ...
        when (viewGroup) {
            ...
            is RelativeLayout -> layoutParams = (layoutParams as RelativeLayout.LayoutParams).apply {
                val endRule = if (VERSION.SDK_INT >= VERSION_CODES.JELLY_BEAN_MR1) ALIGN_END else ALIGN_RIGHT

                height = 0
                addRule(ALIGN_TOP, recyclerViewId)
                addRule(ALIGN_BOTTOM, recyclerViewId)
                addRule(endRule, recyclerViewId)
                setMargins(0, marginTop, 0, marginBottom)
            }
